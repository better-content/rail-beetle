...
final class WhistleResourceTest {
    private static final String WHISTLE = "/assets/rail_scout/sounds/whistle.ogg";
    ...
    void soundsJsonPublishesWhistleEvent() throws IOException {
        String sounds = new String(resource("/assets/rail_scout/sounds.json"), StandardCharsets.UTF_8);
        assertTrue(sounds.contains("\"whistle\""));
        assertTrue(sounds.contains("\"rail_scout:whistle\""));
        assertTrue(sounds.contains("\"subtitles.rail_scout.whistle\""));
    }
