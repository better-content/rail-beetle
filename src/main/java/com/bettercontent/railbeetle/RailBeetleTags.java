...
public final class RailBeetleTags {
    public static final TagKey<Item> USABLE_RAILS = TagKey.create(
            Registries.ITEM, new ResourceLocation(RailBeetleMod.MOD_ID, "usable_rails"));
    public static final TagKey<Block> USABLE_RAIL_BLOCKS = TagKey.create(
            Registries.BLOCK, new ResourceLocation(RailBeetleMod.MOD_ID, "usable_rails"));
    public static final TagKey<Block> CLEARABLE_OBSTRUCTIONS = TagKey.create(
            Registries.BLOCK, new ResourceLocation(RailBeetleMod.MOD_ID, "clearable_obstructions"));
